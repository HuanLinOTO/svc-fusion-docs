...
| 参数名称         | 说明                                                                                                              |
| ---------------- | ----------------------------------------------------------------------------------------------------------------- |
| 训练批次大小     | batch_size（bs），越大越好，越大越占显存，注意不能超过训练集条数。根据显存酌情调整， |
...
|参数名称|说明|
|---|---|
|f0 提取器|用于音高提取/预测的模型，一般认为 remove 最均衡，fcpe 更自然|
...
![image.png](..\imgs\1231231232131.png)

使用此功能需要上传未经处理的歌曲，点击“开始推理”稍等片刻即可看到结果

![image.png](..\imgs\1222222222222.png)