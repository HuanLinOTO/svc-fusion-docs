...
将补丁内文件覆盖到整合包根目录
    `.split(`
`).map(n=>`<p>${n}</p>`).join("")),v.value.push("我已知晓该版本需要安装补丁")),e!=null&&e.linux&&(_.value.push(`
该版本有 Linux 补丁可用
...
详细请看：<a href="/start/linux.html" target="_blank">Linux 补丁使用说明</a>
    `.split(`
`).map(n=>`<p>${n}</p>`).join("")),v.value.push("我已知晓该版本需要安装补丁")),e!=null&&e.env&&(_.value.push(`
该版本需要搭配环境包才可使用
