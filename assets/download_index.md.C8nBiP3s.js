import{n as z}from"./chunks/index.BuQlg4Le.js";import{d as I,h as r,k as F,b as L,w as o,E as H,o as c,J as s,c as w,G as D,F as N,p as t,m as u,t as M,a as d,e as P,_ as K,K as W}from"./chunks/framework.v3b_Jckq.js";const O=g=>atob(g);function A(g){return[...new URL(g).searchParams].reduce((n,[i,h])=>(n[i]=h,n),{})}const G=[{link:"https://www.123pan.com/s/PMNsjv-zw4l.html",date:"2024/8/20",version:"1.2.0",changes:["更新了6.1 的模型训练","修复了sovits 打包问题","新增了DLC 功能","DDSP6.1 实时功能"],env:null},{link:"https://www.123pan.com/s/PMNsjv-zw4l.html",date:"2024/8/20",version:"1.1.0",changes:["更新了人声分离（Kim 的 Vocals）模型","新增去除和声（Karaoke）模型","新增批量人声分离","新增移动到 models文件夹功能","优化打包后的文件名称","支持算力平台","DDSP 实时功能","加了一堆防止眼瞎的按钮高亮","加了部分因为历史遗留问题导致的按钮没名字/不明确的问题","整理小工具","移除了夸克网盘（帮推广没给钱啊）"],env:null},{link:"https://www.123pan.com/s/PMNsjv-zw4l.html",date:"2024/8/2",version:"1.0.0",changes:["正式版发布"],env:null,linux:"https://www.123pan.com/s/BEzKjv-3JVqv.html"},{link:"https://www.123pan.cn/s/PMNsjv-W14l.html",date:"2024/7/22",version:"1.0.0 beta 7",changes:["全新的整合包"],env:null},{link:"https://www.123pan.cn/s/BEzKjv-a06qv.html",date:"2024/6/1",version:"0.0.1",changes:["修复了很多 bug","很忙，之前一直在群里发的，如果你更新了群里的就没必要更新这个了"],env:"v1"},{link:"https://www.123pan.cn/s/BEzKjv-K46qv.html",date:"2024/5/11",version:"0.0.0",changes:["从 DDSP 6.0 整合包迁移, 支持 ReflowVAESVC","**仅供尝鲜，目前没有进行过全量测试，有bug麻烦群内私聊发我**"],env:"v1"}],Z="https://www.123pan.cn/s/BEzKjv-O46qv.html",R={v1:Z},J={class:"tip custom-block"},X={class:"custom-block-title"},Y=["innerHTML"],ee={key:0,class:"disclaimer"},te=["innerHTML"],oe={key:1,class:"disclaimer"},ne=["innerHTML"],se=I({__name:"comp",props:{wait_time:{},link:{},version:{}},setup(g){const{NButton:n,NSpace:i,NModalProvider:h,NCard:f,NModal:y,NCheckbox:T}=z,_=g,b=r([]),S=r([]),k=r([]),V=r(!1),v=r(!0),m=r(!1),B=F(()=>`
 ...
 <p><strong>五、隐私说明的更新</strong></p>
  ...
  `),U=()=>{console.log(k.value),k.value.every(l=>l)&&k.value.length===S.value.length&&V.value&&window.open(x.value,"_blank")},q=r(!1),x=r(""),e=G.find(l=>l.version===_.version);console.log(e),e!=null&&e.patch&&(b.value.push(`该版本需要安装补丁才可使用，补丁 <a href="${e==null?void 0:e.patch}" target="_blank">点击下载</a>
使用方法：
...
`).map(l=>`<p>${l}</p>`).join("")),S.value.push("我已知晓该版本需要安装环境包，并且知道如何安装环境（不知道的看版本额外说明）"));const Q=()=>{_.wait_time>0||(x.value=_.link,q.value=!0)};return(l,p)=>{const $=H("ClientOnly");return c(),L($,null,{default:o(()=>[s(t(h),null,{default:o(()=>[(c(!0),w(N,null,D(b.value,(a,C)=>(c(),w("div",J,[u("p",X,"版本额外说明 "+M(C+1),1),u("div",{innerHTML:a},null,8,Y)]))),256)),s(t(i),{vertical:""},{default:o(()=>[u("div",null,"等待 "+M(_.wait_time)+"s 后，方可点击跳转按钮",1),s(t(n),{onClick:Q,style:{width:"100%"}},{default:o(()=>[d("跳转到 123 云盘")]),_:1})]),_:1}),s(t(y),{show:q.value,"onUpdate:show":p[3]||(p[3]=a=>q.value=a)},{default:o(()=>[s(t(f),{style:{width:"600px"},title:"请确认",bordered:!1,size:"huge",role:"dialog","aria-modal":"true"},{default:o(()=>[s(t(i),null,{default:o(()=>[s(t(n),{type:v.value?"primary":"default",autofocus:v.value,disabled:v.value,onClick:p[0]||(p[0]=a=>{v.value=!0,m.value=!1})},{default:o(()=>[d(" 免责声明 ")]),_:1},8,["type","autofocus","disabled"]),s(t(n),{type:m.value?"primary":"default",autofocus:m.value,disabled:m.value,onClick:p[1]||(p[1]=a=>{m.value=!0,v.value=!1})},{default:o(()=>[d(" 隐私说明 ")]),_:1},8,["type","autofocus","disabled"])]),_:1}),v.value?(c(),w("div",ee,[u("div",{innerHTML:B.value},null,8,te)])):P("",!0),m.value?(c(),w("div",oe,[u("div",{innerHTML:E.value},null,8,ne)])):P("",!0),s(t(i),{vertical:""},{default:o(()=>[(c(!0),w(N,null,D(S.value,(a,C)=>(c(),L(t(T),{checked:k.value[C],"onUpdate:checked":j=>k.value[C]=j},{default:o(()=>[d(M(a),1)]),_:2},1032,["checked","onUpdate:checked"]))),256)),s(t(T),{checked:V.value,"onUpdate:checked":p[2]||(p[2]=a=>V.value=a)},{default:o(()=>[d(" 我同意以上条款 ")]),_:1},8,["checked"]),s(t(n),{style:{width:"100%"},type:"info",onClick:U},{default:o(()=>[d("GOGOGO")]),_:1})]),_:1})]),_:1})]),_:1},8,["show"])]),_:1})]),_:1})}}}),le=K(se,[["__scopeId","data-v-e2aad0a9"]]),ae={id:"下载中转页-version",tabindex:"-1"},re=u("a",{class:"header-anchor",href:"#下载中转页-version","aria-label":'Permalink to "下载中转页 {{ version }}"'},"​",-1),ie=W('<p>您需要查看下列的注意事项后才能跳转到网盘</p><p>其中包含了十分重要的信息，缺失这些可能导致您无法使用整合包</p><div class="warning custom-block"><p class="custom-block-title">如果你显卡垃圾需要上云，以下是云端地址合集：</p><p><strong>1、优云智算（首推，注册送 20 算力，需实名，高校认证后送 10 ）</strong></p><p>SVC-Fusion：<a href="https://www.compshare.cn/images/compshareImage-1aly0zqh3gvc?referral_code=1ywd4VqDKknFWCEUZvOoWo" target="_blank" rel="noreferrer">https://www.compshare.cn/images/compshareImage-1aly0zqh3gvc?referral_code=1ywd4VqDKknFWCEUZvOoWo</a></p><p>MSST：<a href="https://www.compshare.cn/images/compshareImage-19o9qlm9x5f6?referral_code=1ywd4VqDKknFWCEUZvOoWo" target="_blank" rel="noreferrer">https://www.compshare.cn/images/compshareImage-19o9qlm9x5f6?referral_code=1ywd4VqDKknFWCEUZvOoWo</a></p><p><strong>2、AutoDL</strong></p><p>SVC-Fusion：<a href="https://www.codewithgpu.com/i/HuanLinOTO/SVCFusion/svc-fusion" target="_blank" rel="noreferrer">https://www.codewithgpu.com/i/HuanLinOTO/SVCFusion/svc-fusion</a></p><p>MSST：<a href="https://www.codewithgpu.com/i/ZFTurbo/Music-Source-Separation-Training/MSST-webUI" target="_blank" rel="noreferrer">https://www.codewithgpu.com/i/ZFTurbo/Music-Source-Separation-Training/MSST-webUI</a></p><p>或 <a href="https://www.codewithgpu.com/i/SUC-DriverOld/MSST-WebUI/MSST" target="_blank" rel="noreferrer">https://www.codewithgpu.com/i/SUC-DriverOld/MSST-WebUI/MSST</a></p><p><strong>3、星海智算</strong></p><p>SVC-Fusion/MSST：<a href="https://gpu.spacehpc.com/user/register?inviteCode=21777196" target="_blank" rel="noreferrer">https://gpu.spacehpc.com/user/register?inviteCode=21777196</a></p><p><strong>4、算力互联</strong></p><p>SVC-Fusion/MSST：<a href="https://console.casdao.com:9001/#/s-login?refer=236d58849beebe9e243149f256dc90092de32d6a552e46cbfc170118fd22f8a6" target="_blank" rel="noreferrer">https://console.casdao.com:9001/#/s-login?refer=236d58849beebe9e243149f256dc90092de32d6a552e46cbfc170118fd22f8a6</a></p></div><div class="danger custom-block"><p class="custom-block-title">DANGER</p><p><strong>如果启动器无法正常下载或者下载速度很慢，在你检查了你的网络测速没有问题的情况下，这边建议先直接打爆你的宽带运营商电话，质问他为什么屏蔽天翼云的服务</strong></p></div><div class="tip custom-block"><p class="custom-block-title">TIP</p><details class="details custom-block"><summary>新底模相关</summary><p>SVC Fusion 整合包中</p><ul><li>DDSP 6.0 的 cvec768l12 底模是我自己炖的 非官方底模（截至发布也没有官方底模）</li><li>Reflow VAE SVC 的 cvec768l12 底模来自 <a href="https://huggingface.co/OOPPEENN/pretrained_model" target="_blank" rel="noreferrer">bfloat16 的 hf 仓库</a></li></ul></details></div><div class="tip custom-block"><p class="custom-block-title">TIP</p><p>123Pan 链接已更换到 <code>.cn</code> 备用域名，如果无法访问请尝试使用代理</p><p>那群恶意举报的不得好死</p></div>',6),ue=JSON.parse('{"title":"下载中转页","description":"","frontmatter":{"title":"下载中转页"},"headers":[],"relativePath":"download/index.md","filePath":"download/index.md"}'),pe={name:"download/index.md"},ge=I({...pe,setup(g){const n=A(typeof window>"u"?"http://localhost:5173/download/?link=aHR0cHM6Ly93d3cuMTIzcGFuLmNvbS9zL0JFektqdi1lQ3Fxdi5odG1s&version=MS4wLjAgcmMxMS1maXhlZA==":location.href);console.log(n),n.link;const i=O(n.link),h=O(n.version),f=r(10);console.log(i);const y=setInterval(()=>{f.value--,f.value<=0&&clearInterval(y)},1e3);return(T,_)=>(c(),w("div",null,[u("h1",ae,[d("下载中转页 "+M(t(h))+" ",1),re]),ie,s(le,{wait_time:f.value,link:t(i),version:t(h)},null,8,["wait_time","link","version"])]))}});export{ue as __pageData,ge as default};
