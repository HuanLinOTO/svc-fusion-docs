import{n as z}from"./chunks/index.Da_DU5FM.js";import{d as I,h as r,k as F,b as L,w as o,E as H,o as c,J as s,c as w,G as D,F as N,p as t,m as u,t as M,a as d,e as P,_ as K,V as W}from"./chunks/framework.BpLZpJbo.js";const O=g=>atob(g);function A(g){return[...new URL(g).searchParams].reduce((n,[i,h])=>(n[i]=h,n),{})}const G=[{link:"https://www.123pan.com/s/PMNsjv-zw4l.html",date:"2024/8/20",version:"1.2.0",changes:["更新了6.1 的模型训练","修复了sovits 打包问题","新增了DLC 功能","DDSP6.1 实时功能"],env:null},{link:"https://www.123pan.com/s/PMNsjv-zw4l.html",date:"2024/8/20",version:"1.1.0",changes:["更新了人声分离（Kim 的 Vocals）模型","新增去除和声（Karaoke）模型","新增批量人声分离","新增移动到 models文件夹功能","优化打包后的文件名称","支持算力平台","DDSP 实时功能","加了一堆防止眼瞎的按钮高亮","加了部分因为历史遗留问题导致的按钮没名字/不明确的问题","整理小工具","移除了夸克网盘（帮推广没给钱啊）"],env:null},{link:"https://www.123pan.com/s/PMNsjv-zw4l.html",date:"2024/8/2",version:"1.0.0",changes:["正式版发布"],env:null,linux:"https://www.123pan.com/s/BEzKjv-3JVqv.html"},{link:"https://www.123pan.cn/s/PMNsjv-W14l.html",date:"2024/7/22",version:"1.0.0 beta 7",changes:["全新的整合包"],env:null},{link:"https://www.123pan.cn/s/BEzKjv-a06qv.html",date:"2024/6/1",version:"0.0.1",changes:["修复了很多 bug","很忙，之前一直在群里发的，如果你更新了群里的就没必要更新这个了"],env:"v1"},{link:"https://www.123pan.cn/s/BEzKjv-K46qv.html",date:"2024/5/11",version:"0.0.0",changes:["从 DDSP 6.0 整合包迁移, 支持 ReflowVAESVC","**仅供尝鲜，目前没有进行过全量测试，有bug麻烦群内私聊发我**"],env:"v1"}],Z="https://www.123pan.cn/s/BEzKjv-O46qv.html",R={v1:Z},J={class:"tip custom-block"},X={class:"custom-block-title"},Y=["innerHTML"],ee={key:0,class:"disclaimer"},te=["innerHTML"],oe={key:1,class:"disclaimer"},ne=["innerHTML"],se=I({__name:"comp",props:{wait_time:{},link:{},version:{}},setup(g){const{NButton:n,NSpace:i,NModalProvider:h,NCard:f,NModal:y,NCheckbox:V}=z,_=g,b=r([]),S=r([]),k=r([]),T=r(!1),v=r(!0),m=r(!1),B=F(()=>`
 ...
 <p><strong>五、隐私说明的更新</strong></p>
  ...
  `),U=()=>{console.log(k.value),k.value.every(l=>l)&&k.value.length===S.value.length&&T.value&&window.open(x.value,"_blank")},q=r(!1),x=r(""),e=G.find(l=>l.version===_.version);console.log(e),e!=null&&e.patch&&(b.value.push(`该版本需要安装补丁才可使用，补丁 <a href="${e==null?void 0:e.patch}" target="_blank">点击下载</a>
使用方法：
