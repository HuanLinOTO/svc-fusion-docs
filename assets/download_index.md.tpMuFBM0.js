import{n as z}from"./chunks/index.Da_DU5FM.js";import{d as S,h as d,b as B,w as l,E as F,o as r,J as s,c as k,G as D,F as E,p as t,m,t as g,a as b,V as O}from"./chunks/framework.BpLZpJbo.js";const q="/assets/DB89BEF3-A9CF-4d4b-9CDD-D215FBE10D5B_.DUIR8b_p.png",M=i=>atob(i);function G(i){return[...new URL(i).searchParams].reduce((a,[o,c])=>(a[o]=c,a),{})}const I=[{link:"https://www.123pan.com/s/PMNsjv-zw4l.html",date:"2024/8/2",version:"1.0.0",changes:["正式版发布"],env:null,linux:"https://www.123pan.com/s/BEzKjv-3JVqv.html"},{link:"https://www.123pan.cn/s/PMNsjv-W14l.html",date:"2024/7/22",version:"1.0.0 beta 7",changes:["全新的整合包"],env:null},{link:"https://www.123pan.cn/s/BEzKjv-a06qv.html",date:"2024/6/1",version:"0.0.1",changes:["修复了很多 bug","很忙，之前一直在群里发的，如果你更新了群里的就没必要更新这个了"],env:"v1"},{link:"https://www.123pan.cn/s/BEzKjv-K46qv.html",date:"2024/5/11",version:"0.0.0",changes:["从 DDSP 6.0 整合包迁移, 支持 ReflowVAESVC","**仅供尝鲜，目前没有进行过全量测试，有bug麻烦群内私聊发我**"],env:"v1"}],A="https://www.123pan.cn/s/BEzKjv-O46qv.html",R={v1:A},T={class:"tip custom-block"},K={class:"custom-block-title"},U=["innerHTML"],H=S({__name:"comp",props:{wait_time:{},link:{},version:{}},setup(i){const{NButton:a,NSpace:o,NModalProvider:c,NCard:p,NModal:x,NCheckbox:y}=z,u=i,_=d([]),f=d([]),v=d([]),L=()=>{console.log(v.value),v.value.every(n=>n)&&v.value.length===f.value.length&&window.open(C.value,"_blank")},N=d(!1),C=d(""),e=I.find(n=>n.version===u.version);console.log(e),e!=null&&e.patch&&(_.value.push(`
...
将补丁内文件覆盖到整合包根目录
    `.split(`
`).map(n=>`<p>${n}</p>`).join("")),f.value.push("我已知晓该版本需要安装补丁")),e!=null&&e.linux&&_.value.push(`
该版本有 Linux 补丁可用
...
详细请看：<a href="/start/linux.html" target="_blank">Linux 补丁使用说明</a>
    `.split(`
`).map(n=>`<p>${n}</p>`).join("")),e!=null&&e.env&&(_.value.push(`
该版本需要搭配环境包才可使用
